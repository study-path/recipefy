...
const RecipeDetailPage = () => {
  ...
  return (
    <div className="p-4 px-20 ">
      ...
      {recipeDetail ? (
        <div>
          <h1 className="my-2 text-4xl font-medium text-gray-800">
            {recipeDetail.title}
          </h1>
          <div className="flex flex-col items-center gap-4 ">
            <div className="flex border-2 border-pink-400 p-4 w-full max-w-5xl gap-4">
              <div className=" bg-gray-100 shadow-lg/20 rounded-md flex-1 border-2 border-green-400 ">
            ...
            <div className="flex border-2 border-pink-400 p-4 w-full max-w-5xl  gap-4">
              <div className="flex flex-col border-2 border-green-400 flex-1">
                <h3 className="text-2xl font-medium text-center">
                  Ingredients
                </h3>
                <ul className="p-2">
                  {recipeDetail.extendedIngredients.map((ingredient) => (
                    <li key={ingredient.id}>
                      <div className="flex justify-center bg-gray-100 border-md m-4">
                        {ingredient.original}
                      </div>
                    </li>
                  ))}
